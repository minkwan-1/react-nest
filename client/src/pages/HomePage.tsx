      ...
      >
        ...
        <Box
          sx={{
            ...
            gap: 2.5,
            minHeight: 0, // flexbox에서 overflow 동작을 위해 필요
          }}
        >
          <Typography
            sx={{
                ...
                >
                  ...
                  <Box
                    sx={{
                      ...
                      flexGrow: 1,
                      p: 2,
                      minWidth: 0, // 텍스트 overflow 처리를 위해 필요
                    }}
                  >
                    <CardContent
                      sx={{
                    ...
                    >
                      <Typography
                        ...
                        sx={{
                          ...
                          display: "-webkit-box",
                          WebkitLineClamp: 2, // 제목도 2줄로 제한
                          WebkitBoxOrient: "vertical",
                          wordBreak: "break-word",
                        }}
                        title={news.title} // 전체 제목을 툴팁으로 표시
                      >
                        {news.title}
                      </Typography>
                      ...
                      <Typography
                        ...
                        title={news.summary} // 전체 요약을 툴팁으로 표시
                      >
                        {news.summary}
                      </Typography>
                    </CardContent>
